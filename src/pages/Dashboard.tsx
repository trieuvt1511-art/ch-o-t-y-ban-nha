    ...
    <div className="min-h-screen bg-background flex flex-col items-center">
      <div className="w-full max-w-[430px] px-4 pt-6 pb-24">
        ...
        <div className="flex items-center justify-between mb-6 animate-fade-in">
          ...
          <button onClick={() => { logout(); navigate('/'); }} className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-xl hover:bg-muted">
            <LogOut size={20} />
          </button>
        </div>
        ...
        <div className="rounded-2xl bg-card shadow-card p-4 flex items-center gap-4 mb-4 animate-slide-up">
          ...
          <div className="flex-1">
            <p className="text-3xl font-heading font-bold text-foreground">{activeProfile.streak}</p>
        ...
        <div className="grid grid-cols-3 gap-3 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          {[
            ...
            { icon: GraduationCap, label: 'Bài xong', value: activeProfile.scenariosCompleted },
